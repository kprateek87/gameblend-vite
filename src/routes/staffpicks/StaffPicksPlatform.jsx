...
function StaffPicksPlatform() {
  const loaderData = useParams();
  const games = allGames.filter((game) =>
    game.platforms.join("").includes(loaderData.platformNameForStaff)
  );
  return (
    <div className="px-5">
      <div className="text-xl">
        Best Staff Picks {loaderData.platformNameForStaff} Games
      </div>
...
export default StaffPicksPlatform;
